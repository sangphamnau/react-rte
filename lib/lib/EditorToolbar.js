...
var EditorToolbar = function (_Component) {
  ...
  (0, _createClass3.default)(EditorToolbar, [{
    ...
    key: '_setImage',
    value: function _setImage(src, file) {
      var editorState = this.props.editorState;
      ...
      if (file) {
        this.state.files.push({ file: file, url: src });
      }
      this.props.onChange(_draftJs.EditorState.push(editorState, newContentState), this.state.files);
      this._focusEditor();
    }
  }, {
    key: '_setLink',
